...
dir_img = '../cbis_crop/images/'#'data/imgs/CVC/'
dir_mask = '../cbis_crop/masks/0/'#'data/masks/CVC/'
...
if __name__ == '__main__':
    ...
    for batch in train_loader:
       ...
       break
    result_sum = []
    #args.depth means the indivudual layer
    ...
    try:
      ...
      print(result_sum)
      print((np.mean(result_sum,axis = 1)*100),np.std(result_sum,axis = 1)*100)
